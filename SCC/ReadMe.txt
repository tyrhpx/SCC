================================================================================
MICROSOFT 基础类库: SCC 项目概述
===============================================================================

应用程序向导已为您创建了这个 SCC 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
SCC.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CSCCApp 应用程序类。

SCC.cpp
这是包含应用程序类 CSCCApp 的主要应用程序源文件。

SCC.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\SCC.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 SCC.rc 中。
...
SCCDoc.h，SCCDoc.cpp - 文档
这些文件包含 CSCCDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CSCCDoc::Serialize)。

SCCView.h，SCCView.cpp - 文档的视图
这些文件包含 CSCCView 类。
CSCCView 对象用于查看 CSCCDoc 对象。
...
这些文件包含 CSCCCntrItem 类。此类用于操作 OLE 对象。OLE 对象通常由 CSCCView 类显示并作为 CSCCDoc 类的一部分序列化。
